                ...
                <div className="buoy-list">
                  <a href={"/staking?ref=" + ref}>
                    <div className="buoy-item" style={{ width: "10%" }} role="button" >
                      <div className="btn" style={{ backgroundColor: "transparent", padding: "6px" }}>
                        {/* Launch App */}
                        < img src="buttons/launch app.svg" width={191} height={49} alt="launch app" />
                      </div>
                    </div>
                  </a>
                </div>
